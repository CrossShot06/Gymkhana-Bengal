        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 bg-clip-text text-transparent leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-bold px-8 py-4 rounded-full shadow-2xl hover:shadow-yellow-500/25 transition-all duration-300 hover:scale-105"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-yellow-500/50 text-yellow-400 hover:bg-yellow-500/10 px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 bg-transparent"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-amber-500 bg-clip-text text-transparent">
                Campus Vision
              </h2>
            </div>
            ...
            <div className="mt-8">
              <span className="inline-block px-6 py-3 bg-gradient-to-r from-yellow-500/20 to-amber-500/20 rounded-full border border-yellow-500/30 text-yellow-400 font-semibold">
                Our Commitment
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <Card
                key={index}
                className="accenture-card group hover:border-yellow-500/50 transition-all duration-500 hover:scale-105"
              >
                <CardHeader className="text-center pb-4">
                  <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-yellow-500/20 to-amber-500/20 rounded-2xl flex items-center justify-center text-yellow-400 group-hover:scale-110 transition-transform duration-300">
                    {point.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {candidates.map((candidate, index) => (
              <Card
                key={candidate.id}
                className={`accenture-card group hover:border-yellow-500/50 transition-all duration-500 hover:scale-105 ${
                  candidate.featured ? "md:col-span-2 lg:col-span-1" : ""
                }`}
              >
                <CardHeader className="text-center pb-4 relative">
                  <div className="absolute top-4 right-4">
                    <span
                      className={`inline-block px-3 py-1 text-xs font-bold text-black rounded-full bg-gradient-to-r ${candidate.color}`}
                    >
                      VOTE FOR {candidate.positionAbbr}
                    </span>
                  </div>

                  <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden border-4 border-yellow-500/30 group-hover:border-yellow-500/60 transition-all duration-300 group-hover:scale-110">
                    <Image
                      src={candidate.image || "/placeholder.svg?height=96&width=96"}
                      alt={candidate.name}
                      width={96}
                      height={96}
                  ...
                  <div className="space-y-2">
                    <CardTitle className="text-2xl font-bold text-white group-hover:text-yellow-300 transition-colors">
                      {candidate.name}
                    </CardTitle>
                    <p className="text-yellow-400 font-semibold text-lg">{candidate.position}</p>
                  </div>

                  {candidate.featured && (
                    <CardDescription className="text-gray-300 mt-4 leading-relaxed text-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-amber-500 bg-clip-text text-transparent mb-4">
                  Let's Talk
                </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-bold py-4 rounded-lg shadow-2xl hover:shadow-yellow-500/25 transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-yellow-500/20 to-amber-500/20 rounded-full flex items-center justify-center">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-yellow-400 font-semibold">standtogether@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="text-gray-300">
                      <p className="font-semibold text-white mb-1">National Institute of Technology Durgapur</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Official Student Body</h3>
                <p className="text-sm text-gray-400">NIT Durgapur</p>
              </div>
            </div>
            <div className="text-center md:text-right">
              <p className="text-gray-400">© 2024 Gymkhana NITDGP. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
